    ...
    <div className="md:w-full w-[90%] mx-auto">
      <Button
        ...
        className={cn(
          ...
          active ? 'text-[#FF0000] bg-red-50 dark:bg-red-950/20' : 'text-gray-600 hover:text-[#FF0000] hover:bg-red-50/50 dark:hover:bg-red-950/10',
          'md:text-base text-lg py-4 md:py-2 rounded-xl md:rounded-none',
