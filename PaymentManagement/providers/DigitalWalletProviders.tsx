...
import { PaymentProvider, PaymentTab } from 'app/payments/types';
import { getStatusColor, formatFee } from '../../../utils/paymentUtils';

interface DigitalWalletProvidersProps {
...
const DigitalWalletProviders: React.FC<DigitalWalletProvidersProps> = ({
  providers,
  activeTab,
  onConfigure,
  onToggleStatus
  ...
  return (
    <div className="mt-6">
      <h4 className="font-medium text-gray-900 mb-4">Available Wallets</h4>
...
export default DigitalWalletProviders;